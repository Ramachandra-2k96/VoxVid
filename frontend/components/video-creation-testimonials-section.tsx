...
const tweets: Tweet[] = [
  // Featured Tweet - Content creator testimonial
  {
    text: "Just created a 2-minute explainer video in 15 minutes using @VoxVid_AI. Script to video with professional voice and avatar. This is insane! 🎥✨",
    handle: "@sarahcreates",
    name: "Sarah Chen",
  ...
  // Second - Marketing professional
  {
    text: "VoxVid just saved us $50K on video production. What used to take 3 days and a full crew now takes 30 minutes. The quality is incredible.",
    handle: "@marketingmax",
    name: "Max Rodriguez",
    url: "https://x.com/marketingmax/status/example",
    profileImage: "/images/profiles/max.jpg",
    stats: {
      views: "234.1K",
      likes: "4.2K",
      retweets: "156",
  ...
  // Third - Educator
  {
    text: "As a teacher, creating video lessons just got 10x easier. Write the script, pick a friendly avatar, and boom - professional educational content ready to share.",
    handle: "@teachwithtech",
    name: "Dr. Emily Watson",
    url: "https://t.co/example3",
  ...
  // Fourth - Entrepreneur
  {
    text: "they should invent a tool where you write a script and AI creates a full video with voice acting and visuals\n\nlike a ... narrator for content",
    handle: "@startupsteve",
    name: "Steve Martinez",
    url: "https://t.co/example4",
    profileImage: "/images/profiles/steve.jpg",
    stats: {
      views: "98.4K",
      likes: "1.8K",
      retweets: "67",
  ...
  // Fifth - Social media expert
  {
    text: "VoxVid pro tip: Use different avatars for different content types. Professional avatar for B2B, casual one for lifestyle content. Game changer! 📱",
    handle: "@socialsarah",
    name: "Sarah Kim",
    url: "https://x.com/socialsarah/status/example",
    profileImage: "/images/profiles/sarah-kim.jpg",
    stats: {
      views: "76.2K",
      likes: "945",
      retweets: "34",
  ...
  {
    text: "Complex video editing software scares people who just wanna create. Give them AI-powered simplicity",
    handle: "@anushkmittal",
    name: "anushk",
...
interface VideoCreationTestimonialsSectionProps {
}

export default function VideoCreationTestimonialsSection({ }: VideoCreationTestimonialsSectionProps) {
    ...
    <section className="py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-6 md:mb-12 px-4">
          ...
          >
            Video Creation Just Got 10x Easier.
          </h2>
          <p
