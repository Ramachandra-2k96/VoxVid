...
const features: FeatureData[] = [
  {
    id: "script",
    title: "Write Script",
    description: "Transform your ideas into engaging scripts. AI helps craft compelling narratives that captivate your audience.",
    ...
    thumbnailSrc: "/images/script-creation.jpeg",
  },
  {
    id: "voice",
    title: "Choose Voice",
    description: "Select from professional voice actors or AI voices. Customize tone, accent, and style to match your brand.",
    ...
    thumbnailSrc: "/images/voice-selection.jpeg",
  },
  {
    id: "avatar",
    title: "Pick Avatar",
    description: "Choose from diverse avatars or upload custom ones. Match the visual style to your content and audience.",
    videoSrc: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/yoyo-restore-rhqD0huLa48Q51Sy9gzIrIdHk2vu2L.mp4",
    fallbackSrc:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/save-review-restore-g3BK0sricXTSPMzxK4iGrmXBUwPt11.mp4",
    thumbnailSrc: "/images/avatar-selection.jpeg",
  },
]
...
export default function SaveReviewRestoreSection({ }: SaveReviewRestoreSectionProps) {
  ...
  return (
    <div className="my-24">
      ...
      <div className="text-center mb-6 md:mb-12 px-4">
        ...
        >
          Video creation made simple. Write your script, customize voices and avatars, then generate professional videos instantly.
        </p>
      </div>
            ...
            <div className="rounded-t-lg overflow-hidden shadow-2xl max-w-4xl mx-auto border border-white/10 border-b-0 relative">
              ...
              <div className="absolute inset-0 hidden lg:flex flex-col justify-end p-6 lg:p-8">
                ...
                <div className="flex gap-4 lg:gap-8 items-end">
                  ...
                  {/* Right: Thumbnails - Now using actual VoxVid interface images */}
                      ...
                      >
                        ...
                        >
                          <img
                            ...
                            alt={`${feature.title} feature of VoxVid`}
